...
from financecs.domain.contexts import TaskContext, SystemContext
from financecs.domain.messages import UserMessage, BotMessage, FocusedObject
...
class DialogueState:
    ...
    def close_current_session(self):
        """
        职责：更新当前session对象的closed_at属性以及清空current_session_id（防御：无当前会话时安全跳过）
        Returns:
        """
