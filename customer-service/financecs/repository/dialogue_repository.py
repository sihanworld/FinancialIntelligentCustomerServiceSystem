...
from financecs.repository.dialogue_record import DialogueRecord
...
class DialogueRepository:
    ...
    async def save_state(self,
        ...
        # 2. 定义SQL语句
        # 2.1 定义INSERT的SQL语句
        insert_stmt = insert(DialogueRecord).values(sender_id=sender_id, customer_no=sender_id, state_json=dialogue_state_str)
