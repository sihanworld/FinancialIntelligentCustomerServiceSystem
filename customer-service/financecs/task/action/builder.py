...
from financecs.task.action.base import Action
from financecs.task.action.builtin.listener import ActionListener
from financecs.task.action.builtin.response import ActionResponse
from financecs.task.action.register import ActionRegister
...
def registry_finance_action(action_runner: ActionRunner):
    """
    ...
    """
    customer_action_package = importlib.import_module("financecs.task.action.finance")
...
def build_action_runner() -> ActionRunner:
    ...
    registry_finance_action(action_runner)
